    ...
    const useMobileVacationHours = () => {
        ...
        fetch(`${api}/portal/vacation-leave`, {
            ...
            headers: {
                "Content-Type": "application/json",
                "email": email,
                "vacation-hours": displayedMobileVacationHoursToUse
            }
        })
        .then(response => {
            return response.json();
                        ...
                        <div className="mobile-vacation-leave-section">
                            ...
                            <div className="mobile-vacation-pie-container">
                                <div className="mobile-portal-vacation-leave">
                                    <div id="mobile-vacation-pie">
                                        <div id="mobile-vacation-pie-background"></div>
                                    </div>                            
                                </div>
                ...
                <div id="sick-leave-page" className="sick-leave-mobile-body mobile-container">
                    ...
                    <section id="sick-row-2">
                        <div className="mobile-sick-leave-section">
                            ...
                            <div className="mobile-sick-remaining-container">
                                <div className="mobile-sick-block mobile-sick-remaining-block">{sickHours}</div>
                                <p>Sick Hours Remaining</p>
                            </div>
                            <div className="mobile-sick-spacer-container">
                                <div className="mobile-sick-block"></div>
                            </div>
                            <div className="mobile-sick-used-container">
                                <div className="mobile-sick-block mobile-sick-used-block">0</div>
                                <p>Sick Hours Used</p>
                            </div>
                            <div className="mobile-sick-pie-container">
                                ...
                                <div className="sick-pie-hours">
                                    <p className="mobile-sick-pie-hours-text">{sickHours}</p>
                                </div>
                            </div>
                    ...
                    <section id="sick-row-three">
                        <div className="mobile-sick-add-remove-section">
                            ...
                            <div className="add-remove-sick-text">
                    ...
                    <section id="sick-row-four">
                        <div className="mobile-sick-company-section">
                            <div className="company-section-banner">
